    ...
    return (
        <>
            ...
            <div className="page-header">
                <Container>
                    <Row>
                        <Col className="mr-auto" lg="4">
                            ...
                            <h5 className="title font-weight-bold">The Yellow House</h5>
                            <h6 className="font-italic">By Vincent van Gogh</h6>                           
                        </Col>
                ...
                {/*        color="warning"*/}
                {/*            href="https://youtu.be/asdM2znz3OM"*/}
                {/*    >*/}
                ...
                {/*            className="btn-icon col-md-2 offset-md-6"*/}
                {/*            color="warning"*/}
                {/*            href="https://youtu.be/p9wy03frCwI"*/}
                {/*        >*/}
                {/*            <span className="btn-inner--icon">*/}
                {/*                <i className="ni ni-button-play"></i>*/}
                {/*            </span>*/}
...
export default SimpleListeningPage6;
